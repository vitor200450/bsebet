...
function FooterLegalBlock({ align }: { align: "center" | "end" }) {
	...
	return (
		<div
			className={`flex flex-col gap-4 ${isCentered ? "max-w-2xl items-center" : "md:max-w-md md:text-right"}`}
		>
			<nav
				aria-label={t("footer.legalNav")}
				className={`flex flex-wrap gap-x-4 gap-y-2 ${isCentered ? "justify-center" : "md:justify-end"}`}
			>
