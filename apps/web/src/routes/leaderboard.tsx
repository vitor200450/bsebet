		...
		<div className="min-h-screen bg-paper bg-paper-texture">
			<div className="mx-auto flex w-full max-w-2xl flex-col items-center px-4 py-8">
				...
				<div className="mb-4 w-full border-[3px] border-black bg-white shadow-[4px_4px_0px_0px_#000]">
					...
					<div className="grid grid-cols-1 divide-y-[2px] divide-black/10 sm:grid-cols-2 sm:divide-y-0 lg:grid-cols-3">
						...
						<div className="flex items-center gap-3 px-4 py-3 sm:border-black/10 sm:border-l-[2px]">
						...
						<div className="flex items-center gap-3 px-4 py-3 lg:border-black/10 lg:border-l-[2px]">
						...
						<div className="flex items-center gap-3 px-4 py-3 sm:border-black/10 sm:border-l-[2px] lg:border-l-0">
						...
						<div className="flex items-center gap-3 px-4 py-3 sm:border-black/10 sm:border-l-[2px]">
							<div className="flex h-7 w-7 flex-shrink-0 items-center justify-center border-[2px] border-black bg-gray-100 font-black font-display text-black text-sm shadow-[2px_2px_0px_0px_#000]">
								6
							</div>
							<div>
								<p className="font-black text-black text-xs uppercase leading-none">
				...
				<div className="mb-6 flex flex-wrap items-center justify-center gap-2 rounded-lg border-2 border-black/10 bg-white/50 px-3 py-2">
					...
					<div className="flex items-center gap-1">
						<div className="flex items-center gap-0.5 border-2 border-black bg-purple-400 px-1 py-0.5">
							<span className="font-black font-display text-[10px] text-black">⚡</span>
							<span className="font-black font-display text-[10px] text-black">
								0
							</span>
						</div>
				...
				<div className="mt-3 flex flex-col items-center gap-2">
					...
					<div className="flex flex-wrap items-center justify-center gap-1.5 sm:gap-2">
						...
						{entry.underdogPicks > 0 && (
							...
							>
								<span className="font-black font-display text-black text-xs sm:text-sm">⚡</span>
								<span className="font-black font-display text-black text-xs sm:text-sm">
									{entry.underdogPicks}
								</span>
							</div>
				...
				<div className="mt-1.5 flex flex-wrap items-center gap-1.5">
					...
					{entry.underdogPicks > 0 && (
						<div
							...
							title="Azarões acertados"
						>
							<span className="font-black font-display text-black text-xs">⚡</span>
							<span className="font-black font-display text-black text-xs">
								{entry.underdogPicks}
							</span>
						</div>
