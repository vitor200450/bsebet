...
export const getUserBetsOptimized =
	getUserBetsOptimizedFn as unknown as (opts: {
		data?: void;
	}) => Promise<any[]>;
...
export const getMatchDaysOptimized =
	getMatchDaysOptimizedFn as unknown as (opts: {
		data: { tournamentId: number };
	}) => Promise<any[]>;
